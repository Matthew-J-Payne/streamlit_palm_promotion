...
st.sidebar.markdown("Contact me at matthewjpayne1@gmail.com, if you're interested in collaborations or just talking!")
...
with column1:
    ...
    st.write("This is deforestation derived from the Global Forest Watch dataset from Hansen et al., (2013). Source: Hansen/UMD/Google/USGS/NASA")
    st.plotly_chart(deforestation_function())

with column2:
    st.header("Oil palm expansion 2000 - 2015")
    st.write("...and this is oil palm delineated using photo-interpretation and age estimation techniques.")
